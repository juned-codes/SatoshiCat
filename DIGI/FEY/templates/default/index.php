    ...
    <body class="d-flex flex-column">
    	...
    	<nav class="navbar navbar-expand-md <?= (in_array($settings['theme'], array('cyborg', 'solar','superhero'))) ? 'navbar-dark bg-dark' : (in_array($settings['theme'], array('litera','simplex','spacelab','default'))? 'navbar-light bg-light' : 'navbar-dark bg-primary');?>">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/btc-usdt.php">BTC/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/bnb-usdt.php">BNB/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/doge-usdt.php">DOGE/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/eth-usdt.php">ETH/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/ltc-usdt.php">LTC/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/dogs-usdt.php">DOGS/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/matic-usdt.php">MATIC/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/op-usdt.php">OP/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/sol-usdt.php">SOL/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/sui-usdt.php">SUI/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/ton-usdt.php">TON/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/xrp-usdt.php">XRP/USDT</a></li>
            <li><a class="dropdown-item" href="https://satoshicat.org/DIGI/FEY/market/trx-usdt.php">TRX/USDT</a></li>
         ...
         <div class="navbar-nav">
             <a class="nav-link" href="https://satoshicat.org/DIGI/FEY/wallet/index.php" role="button" aria-expanded="false">
            Wallet
          </a>
        </div>

        <div class="navbar-nav">
             <a class="nav-link" href="https://satoshicat.org/DIGI/FEY/swap/index.php" role="button" aria-expanded="false">
            Swap
          </a>
        </div>

        <div class="navbar-nav">
             <a class="nav-link" href="https://satoshicat.org/blog/index.php" role="button" aria-expanded="false">
            Blogs
          </a>
        </div>
					...
					<?php } ?>
					 ...
					 <div class="navbar-nav">
             <a class="nav-link" href="https://satoshicat.org/Auth/logout.php" role="button" aria-expanded="false">
            Logout
          </a>
              </div>
                </div>
...
<gecko-coin-price-marquee-widget locale="en" dark-mode="false" outlined="true" coin-ids="polygon-ecosystem-token,matic-network,dogs-2,bitcoin,solana,zcash,binancecoin,arbitrum" initial-currency="usd"></gecko-coin-price-marquee-widget>
  ...
  <img src="images/feyorra.png" class="rounded" alt="Feyorra Faucet">
</div>
<h3 style="align-item: center; text-align:center;">Feyorra </h3>
    				...
    				?>
        				...
        				<form class="form" method="POST" action="<?= $_SERVER['REQUEST_URI'];?>">
        					...
        					<div class="form-group" id="captcha-adspace">
        						<iframe src="https://ad2bitcoin.com/ad.php?ref=juned7738&width=300" marginwidth="0" marginheight="0" width="300" height="250" scrolling="no" border="0" frameborder="0"></iframe>
        					</div>
							<div class="form-group">
            ...
            <div class="container text-center">
                ...
                <div class="col-12 col-md-6 col-lg-5 float-md-right">
                    <div class="text-center text-md-right">
                        Powered by <a href=""><b>Satoshi</b> Cat</a>
                    </div>
                </div>
            </div>
        </footer>
