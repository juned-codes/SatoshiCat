            		...
            		<div class="col-12 text-left">
                            <div class="tab-content text-left" id="myTabContent">
                                ...
                                <div class="tab-pane fade<?= ((($_POST['tab'] == 'shortlinks'))? ' show active' : '');?>" id="shortlinks" role="tabpanel" aria-labelledby="shortlinks-tab">
        							...
        							if($settings['sldata']){ ?>
        							    <?php $settings['shortlinks'] = json_decode($settings['shortlink'],true); ?>
...
<div class="col-12 text-left">
    <div class="tab-content text-left" id="myTabContent">
        <?= $result; ?>
        <div class="tab-pane fade<?= ((($_POST['tab'] == 'quiz') || (empty($_POST['tab']))) ? ' show active' : '');?>" id="quiz" role="tabpanel" aria-labelledby="quiz-tab">
            <form action="" class="form p-2" method="post">
                <div class="row">
                    <!-- Quiz Information -->
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="<?= $quiz['title']; ?>" name="quiz_title" id="quiz_title">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="quiz_description">Description <small>(Optional)</small></label>
                            <textarea rows="3" class="form-control" id="quiz_description" name="quiz_description"><?= $quiz['description']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="quiz_status">Status</label>
                            <select class="form-control" id="quiz_status" name="quiz_status">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <textarea rows="3" class="form-control" id="question_text" name="question_text"><?= $question['question']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="option_a">Option A</label>
                            <input class="form-control" type="text" value="<?= $question['option_a']; ?>" id="option_a" name="option_a">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="option_b">Option B</label>
                            <input class="form-control" type="text" value="<?= $question['option_b']; ?>" id="option_b" name="option_b">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="option_c">Option C</label>
                            <input class="form-control" type="text" value="<?= $question['option_c']; ?>" id="option_c" name="option_c">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="option_d">Option D</label>
                            <input class="form-control" type="text" value="<?= $question['option_d']; ?>" id="option_d" name="option_d">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="correct_option">Correct Option</label>
                    ...
                    <div class="col-12 my-4 pt-3 text-left flex-grow" style="border-top: 1px solid #dee2e6;">
                        <input type="submit" name="update_quiz" class="btn btn-info" value="Update Quiz">
                    </div>
                </div>
            </form>
        </div> <!-- ./ tab-pane -->
